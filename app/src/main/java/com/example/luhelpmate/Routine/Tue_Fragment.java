...
public class Tue_Fragment extends Fragment {
                ...
                if (value != null && value.exists()) {
                    ...
                    if (matcherDigit.find()) {
                        if (matcherLetter.find()) {
                            ...
                            reference.child(matcherDigit.group()).child(matcherLetter.group()).child("TUESDAY").orderByChild("timeSlot").addValueEventListener(new ValueEventListener() {
                                @Override
                            ...
                            reference = FirebaseDatabase.getInstance().getReference().child("Student Routine");
                            reference.child(matcherDigit.group()).child("TUESDAY").orderByChild("timeSlot").addValueEventListener(new ValueEventListener() {
                                @Override
                                public void onDataChange(@NonNull DataSnapshot snapshot) {
                                    list = new ArrayList<>();
                        ...
                        reference.child(value.getString("initial")).child("TUESDAY").orderByChild("timeSlot").addValueEventListener(new ValueEventListener() {
                            @Override
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                list = new ArrayList<>();
