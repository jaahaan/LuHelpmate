                ...
                if (value != null && value.exists()) {
                    ...
                    if (matcherDigit.find()) {
                        if (matcherLetter.find()) {
                            ...
                            reference.child(matcherDigit.group()).child(matcherLetter.group()).child("MONDAY").orderByChild("timeSlot").addValueEventListener(new ValueEventListener() {
                                @Override
                            ...
                            reference = FirebaseDatabase.getInstance().getReference().child("Student Routine");
                            reference.child(matcherDigit.group()).child("MONDAY").orderByChild("timeSlot").addValueEventListener(new ValueEventListener() {
                                @Override
                                public void onDataChange(@NonNull DataSnapshot snapshot) {
                                    list = new ArrayList<>();
                        ...
                        reference.child(value.getString("initial")).child("MONDAY").orderByChild("timeSlot").addValueEventListener(new ValueEventListener() {
                            @Override
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                list = new ArrayList<>();
